...
function Ber() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:3040/lihat-ucapan/${Id}`)
      .then((response) => {
        setUcapan(response.data.pesan); // Mengisi state dengan data sejarah yang sudah ada
      })
      .catch((error) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put(`http://localhost:3040/edit-ucapan/${Id}`, data)
      .then((response) => {
            ...
            <form onSubmit={handleSubmit} className="bg-white">
              <div>
                <label
                  ...
                  className="d-flex flex-column pt-4 text-black"
                >
                  <b style={{ marginLeft: "300px" }}>UCAPAN</b>
                </label>
